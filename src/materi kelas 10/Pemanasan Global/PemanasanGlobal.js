document.addEventListener("DOMContentLoaded", function () {
  ...
  // elemen
  const lanjutPenyebabPemanasanGlobal = document.getElementById("lanjutPenyebabPemanasanGlobal");
  ...
  function perbaruiProgres() {
    ...
    if (getDataFromStorage().penyebabPemanasanGlobal === true) {
      ...
      nextButtonLink.setAttribute("href", "/src/materi kelas 10/Pemanasan Global/PenyebabPemanasanGlobal.html");
      lanjutPenyebabPemanasanGlobal.classList.remove("hidden");
    }
  ...
  form.addEventListener("submit", function (e) {
    ...
    fetch(action, {
      ...
      if (getDataFromStorage().penyebabPemanasanGlobal === false) {
        if (cekSkor() === true) {
          const updateProgres = getDataFromStorage();
          updateProgres.penyebabPemanasanGlobal = true;
