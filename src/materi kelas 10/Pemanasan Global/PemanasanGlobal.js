document.addEventListener("DOMContentLoaded", function () {
  ...
  const lanjutAktivitas3 = document.getElementById("lanjutAktivitas3");
    ...
    form.addEventListener("submit", function (e) {
      ...
      fetch(action, {
        ...
        setTimeout(function () {
          ...
          if (localStorage.getItem(aktivitas3Key) === "false") {
            cekSkor();
            renderAktivitas();
          }
          location.reload();
  ...
  function renderAktivitas() {
    ...
    if (localStorage.getItem(aktivitas3Key) === "true") {
      ...
      lanjutAktivitas3.classList.remove("hidden");
  ...
  function cekSkor() {
    ...
    if (skor >= 3) {
      localStorage.setItem(aktivitas3Key, true);
    }
    return skor;
  }
