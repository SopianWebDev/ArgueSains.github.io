...
const localAktivitasDiskusi = localStorage.getItem(aktivitasDiskusiKey);
  ...
  form.addEventListener("submit", function (e) {
    ...
    fetch(action, {
      ...
      setTimeout(function () {
        ...
        if (localStorage.getItem(aktivitasDiskusiKey) === "false") {
          cekSkor();
          renderAktivitas();
        }
        location.reload();
...
function cekSkor() {
  ...
  if (skor >= 3) {
    localStorage.setItem(aktivitasDiskusiKey, true);
  }
  return skor;
}
